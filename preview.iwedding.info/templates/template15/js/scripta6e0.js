(function($) {
   ...
   if ($("#wish-form").length) {
        $("#wish-form").validate({
            ...
            messages: {
                name: {
                    required: (typeof messageNameRequired != 'undefined') ? messageNameRequired : 'Vui lòng nhập tên của bạn.',
                    minlength: (typeof messageNameMinlength != 'undefined') ? messageNameMinlength : 'Tên phải lớn hơn 3 ký tự.',
                },
                content: {
                    required: (typeof messageContentRequired != 'undefined') ? messageContentRequired : 'Vui lòng nhập lời chúc.',
                    minlength: (typeof messageContentMinlength != 'undefined') ? messageContentMinlength : 'Lời chúc phải lớn hơn 10 ký tự.',
                },
                email: {
                    email: (typeof messageEmailEmail != 'undefined') ? messageEmailEmail : 'Địa chỉ email không hợp lệ.',
                }
            },
